...
for i = 2:m-1
    for j= 2:n-1
       im_final1(i,j) = img_grey(i,j) + img_grey(i-1,j-1) + img_grey(i-1,j) + img_grey(i-1,j+1) + img_grey(i,j-1) + img_grey(i,j+1)+ img_grey(i+1,j-1) + img_grey(i+1,j)+ img_grey(i+1,j+1);
       im_final1(i,j) = im_final1(i,j) ./ 9 ;
    end
end
...
for i = 2:m-1
    for j= 2:n-1
       im_final2(i,j) = 4 * img_grey(i,j) + img_grey(i-1,j-1) + 2*img_grey(i-1,j) + img_grey(i-1,j+1) + 2*img_grey(i,j-1) + 2*img_grey(i,j+1)+ img_grey(i+1,j-1) + 2*img_grey(i+1,j)+ img_grey(i+1,j+1);
       im_final2(i,j) = im_final2(i,j) ./ 16 ;
    end
end
